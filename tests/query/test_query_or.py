...
@pytest.mark.parametrize(
    "entities, where_clause, or_clauses, use_properties, expected_entities, direction, order_by_key",
    [
        ([InMemoryOrder(id=uuid4(), total_amount=50)],
         {"total_amount": 60},
         [{"total_amount": 70}],
...
@pytest.mark.parametrize(
    "entities, where_clause, or_clauses, use_properties, expected_entity",
    [
        ([InMemoryOrder(id=uuid4(), total_amount=50)],
         {"total_amount": 60},
         [{"total_amount": 70}],
